...
def encodeDataInImage(image,data):
	...
	if len(binary) > len(image.getdata())*4:
		raise Exception("Err, can't encode more than " + len(evenImage.getdata())*4 + " bits in this Image")
...
encodeDataInImage(Image.open("test.png"), 'hello world, funcking nice!!!').save('encodeImage.png')
